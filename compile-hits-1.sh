...
# this is, for the moment, specific to dataset 1
...
#grep "UnalignedBases" "${BASE_DIR}/outputs/*report" | sed 's/[()%]/ /g' | awk '{if($3 < 20) print $0;}' | awk 'BEGIN{FS=".";}{print $1;}' | awk 'BEGIN{FS="/";}{print $(NF);}' > "${1}-kp-hits.txt"
